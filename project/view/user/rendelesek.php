<?php 
if($_SESSION['user']['admin'] == 1){//Admin rendelés felület, rendelesMegtekintes alapján
    ...
    echo '<form method="post" action="index.php?action=rendelesMegtekint&act=kif"><input type="text" name="knev"><input type="submit" value="Szűrés név alapján"></form><hr>';
    echo '<div class="sor">';
